...
function comingSoonCountdown() {
    ...
    $('#commingSoonCountdown').countdown('2021/01/01', function(e){
        $(this).html(e.strftime(''
            + '<div><p>%D</p><span>dias</span></div>'
            + '<div><p>%H</p><span>horas</span></div>'
            + '<div><p>%M</p><span>minutos</span></div>'
            + '<div><p>%S</p><span>segundos</span></div>'
        ));
    });
}
